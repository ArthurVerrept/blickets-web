...
const myCreatedEvents = ref<any>([])
const myCreatedEventsLoading = ref(true)
...
onBeforeMount(async () => {
  ...
  const priceRes = await props.request.get('/blockchain/eth-price')
    ...
    myCreatedEvents.value = await props.request.post('/event/my-created-events', { address: props.address })
    myCreatedEventsLoading.value = false
})
    ...
    <div class="px-24 pb-24">
      <div class="flex justify-evenly">
        <div class="w-1/3 pr-4">
          <div class="px-6 pb-6 h-full overflow-auto bg-white border border-gray-200 h-[40rem]">
        ...
        <div class="w-2/3">
          <div class="px-6 pb-6 h-full overflow-auto bg-white border border-gray-200 h-[40rem]">
            ...
            <div class="grid grid-cols-3 gap-2">
              ...
              <div v-if="!myCreatedEventsLoading && myCreatedEvents.events" v-for="event in myCreatedEvents.events">
                <div class="max-w-sm bg-white  border border-gray-200">
                  ...
                  <div class="p-5">
                    ...
                    <p class="mb-3 font-normal text-stone-800 truncate">Contract Address:</p>
                    <div class="overflow-auto y-scroll">
                      <p class="mb-3 font-normal text-stone-800 ">{{event.contractAddress}}</p>
                    </div>
              ...
              <div v-else-if="!myCreatedEventsLoading && !myCreatedEvents.events">
                <p>You have not listed any events.</p>
              </div>
            </div>
              <div v-if="myCreatedEventsLoading" class="w-full flex justify-center">
